                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    >
                      ...
                      <ShoppingCartIcon className="h-6 w-6" aria-hidden="true" />
                      <span className="inline-flex items-center rounded-md mb-7 -ml-3 bg-gray-50 px-1.5 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">
        1
      </span>
                    </button>
                  </div>
